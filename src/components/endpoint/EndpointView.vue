...
<template>
    <div class="bg-page flex h-full flex-col gap-6 overflow-y-auto p-5">
        <div v-if="endpoint" class="flex flex-col gap-4">
            <!-- Header -->
            <section class="flex flex-col gap-1">
                <div class="flex items-center gap-2">
                    <h1 class="text-primary font-mono text-xl font-semibold">
                        {{ endpoint.name }}
                    </h1>
                    <span
                ...
                <p v-if="endpoint.description" class="text-dim text-sm">
            ...
            <section
                class="bg-card rounded-lg border border-neutral-200 p-4 dark:border-neutral-700"
            >
