...
export const BLOCK_TYPES: BlockType[] = [
    {
        ...
        url: 'https://raw.githubusercontent.com/unyt-org/datex-core/feat/variant-access/tests/structs/receivers/block.bin'
    },
    {
        id: 'no_receivers',
        label: 'No Receivers',
    ...
    },
    {
        ...
        url: 'https://raw.githubusercontent.com/unyt-org/datex-core/feat/variant-access/tests/structs/receivers_with_keys/block.bin'
    },
    {
        id: 'single_receiver_request',
        label: 'Single Receiver Request',
        description: 'Request block with single receiver',
        url: 'https://raw.githubusercontent.com/unyt-org/datex-core/feat/variant-access/tests/structs/single_receiver_request/block.bin'
    },
    {
        id: 'with_payload',
        label: 'With Payload',
        description: 'Block containing payload data',
        url: 'https://raw.githubusercontent.com/unyt-org/datex-core/feat/variant-access/tests/structs/with_payload/block.bin'
    }
];
