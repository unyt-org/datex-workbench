<!-- this is a temporary wrapper file that statically fetches an example block.bin file -->
<!-- this will later on be done by passing the prop accordingly when needed -->
